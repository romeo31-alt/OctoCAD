...
clear;
clc;
load /home/ubuntu/.OctoCAD/spur-gear/user_input.txt; %loads the data collected by the Gui.py program into the memory
cd /home/ubuntu/modules-OctoCAD/gear/spur-gear/bis/v-bis-20200602/; %changes the current working directory to v-bis-20200602
