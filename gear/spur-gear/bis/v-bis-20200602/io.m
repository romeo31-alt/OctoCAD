...
clear;
clc;
load /home/ubuntu/.OctoCAD/user_input.txt; %loads the data collected by the Gui.py program into the memory
cd /home/ubuntu/OctoCAD/gear/spur-gear/bis/v-bis-20200602/; %changes the current working directory to v-bis-20200602
[Fd, Fap, Fag, Fw, BHN, m, FOS, zp, zg] = spur_module (Sutp,Sutg,Ep,Eg,zp,zg,grade,y,P,Np,Q,FOSr,cs); %calls spur_module function
result_f=fopen("/home/ubuntu/.OctoCAD/result.txt","w"); %creates or overwrites the result.txt file
